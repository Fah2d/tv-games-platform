...
export default function PhotoGamePage() {
  ...
  function handleJoin() {
    ...
    router.push(`/games/photogame/player-view?code=${code}&name=${encodeURIComponent(name)}`)
  }
    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-6 text-white" dir="rtl">
      <div className="max-w-sm w-full">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-white mb-1">لعبة الصور</h1>
          <p className="text-zinc-400 text-sm">اكتشف صورة خصمك قبل ما يكتشف صورتك</p>
        </div>

        {view === 'menu' && (
          <div className="flex flex-col gap-4">
            <button
              onClick={() => router.push('/games/photogame/setup')}
            ...
            <a href="/" className="text-center text-zinc-500 hover:text-zinc-300 text-sm transition-colors mt-2">
              العودة للرئيسية
            </a>
          </div>
        )}
