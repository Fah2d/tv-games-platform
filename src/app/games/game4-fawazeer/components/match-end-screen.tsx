    ...
    <div className="min-h-screen bg-bg-primary flex flex-col items-center justify-center gap-10">
      ...
      {winner && (
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at center, ${winner.color} 0%, transparent 70%)`,
          }}
        />
      )}

      <Confetti team1Color={teams[0].color} team2Color={teams[1].color} />
      ...
      <div className="flex flex-col items-center gap-3">
        <p className="text-text-muted text-base animate-fade-in-up [animation-delay:500ms]">
          {winner ? 'بطل المباراة' : 'تعادل!'}
        </p>
        {winner ? (
          <>
            <p
          ...
          <p className="text-3xl font-bold text-text-primary animate-scale-fade-in [animation-delay:800ms]">
            الفريقان متعادلان
          </p>
        )}
      </div>
